      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="max-w-5xl mx-auto px-8 py-4 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 transition-colors">
            ...
            <span className="text-xl font-bold text-slate-800 tracking-tight">UBE<span className="text-indigo-600">Safety</span></span>
          </Link>
          <nav className="flex items-center gap-6">
            {user ? (
              <>
                <Link to="/hotspots" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Hotspot Map
                </Link>
                <Link to="/report" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Submit a Report
                </Link>
                <Link to="/check" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Check Status
                </Link>
                <Link to="/contacts" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Contacts
                </Link>
                <Link to="/safe-zones" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Safe Zones
                </Link>
                <Link to="/ride" className="text-sm font-medium text-slate-500 hover:text-slate-800">
                  Share Ride
                </Link>
